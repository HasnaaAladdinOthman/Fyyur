...
from wtforms.validators import InputRequired, DataRequired, AnyOf, Regexp, URL
...
class VenueForm(Form):
    ...
    image_link = StringField(
        ...
        Regexp('[(http(s)?):\/\/(www\.)?a-zA-Z0-9@:%._\+~#=]{2,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:%_\+.~#?&//=]*)', message="Invalid URL")]
    )
